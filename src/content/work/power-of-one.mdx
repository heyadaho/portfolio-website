...
image: "/images/Po1/po1-live-platform.webp"
---
...
<MediaBlock
  src="/images/Po1/po1-brand-landscape.webp"
...
<MediaBlock
  src="/images/Po1/po1-research-synthesis.webp"
...
<MediaTripleBlock
  srcLeft="/images/Po1/po1-lofi-search.webp"
  altLeft="Early lo-fi wireframe of the search results page"
  srcMid="/images/Po1/po1-midfi-search.webp"
  altMid="Mid-fidelity search results structure"
  srcRight="/images/Po1/po1-hifi-search.webp"
...
<TextBlock heading="User impact">
  ...
  The number I'd actually point to is dwell time. Three minutes forty-seven on a tour page, excluding bounces, is a long time to spend on something you aren't seriously considering.
</TextBlock>

<MediaBlock
  src="/images/Po1/po1-live-platform.webp"
  alt="Live platform screens — tour page, search results, and homepage across multiple brands"
  caption="The live platform — one system, built to serve the full portfolio. Trip page across the five pilot brands migrated onto PO1: Insight Vacations, Luxury Gold, Contiki, Costsaver, and Trafalgar."
/>
