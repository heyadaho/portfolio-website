...
<TextBlock label="Snapshot">
  loveholidays' design system hadn't received meaningful technical investment in four years. Documentation was scattered across Figma, Storybook, and Google Docs. No single source of truth. No ownership. As AI-assisted development accelerated across the company, this became a structural liability. AI tools don't interpret undocumented knowledge. They default to generic patterns and ignore brand conventions. The result, as observed across the team: more than a dozen internal AI prototypes that looked like they came from different companies, and ideas that took ten minutes to generate but the better part of two days to bring back onto brand. Both are directional observations rather than tracked measurements — nobody was timing it, which is part of the problem this work set out to fix.
