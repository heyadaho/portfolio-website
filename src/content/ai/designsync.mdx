...
<TextBlock label="Context and Stakes">
  ...
  We structured the project around seven testable hypotheses, from brand-aligned AI output through to market scalability and governance. The most important was H7: the cost of inaction compounds. Every month of delay raises the remediation cost as more AI-generated work piles onto a weak foundation.
